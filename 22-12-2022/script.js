...
//come il metodo `parseInt`che preso un numero come parametro lo ritorni senza virgola,
//es: 23.23323 => 23
...
const project = [{
  ...
  "rating": {
   ...
   function calculator(project) {
    for (let i=0; i< project.length; i++) {
      console.log(project[i].title);
      console.log(project[i].price);
      console.log(project[i].rating.count);
    }
   }
   calculator(project);
